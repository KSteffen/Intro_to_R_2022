...
head(mpg$cty)
mpg[1:2, c("manufacturer", "model", "displ", "year", "cyl", "trans")]
mpg[mpg$manufacturer=="lincoln",] #select rows that match a condition
```

## S4 object

Specifically defined tables or more complex data structures
