...
key <- read_csv("Exercise_material/key.csv") # read_csv() is a specialised version for csv files
...
# The solutions below are redundant - running the code as is won't work,
# but try the methods that appeal to you :)
